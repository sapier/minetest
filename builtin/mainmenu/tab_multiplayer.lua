...
local function get_formspec(tabview, name, tabdata)
	...
	local retval =
		"vertlabel[0,-0.15;".. fgettext("CLIENT") .. "]" ..
		"label[1,-0.1;".. fgettext("Favorites:") .. "]"..
		"label[9.3,3;".. fgettext("Name/Password") .. "]" ..
		"field[1,5.25;5.25,0.5;te_address;" .. fgettext("Address/Port") .. ";" ..core.setting_get("address") .."]" ..
		"field[6.5,5.25;2.25,0.5;te_port;;" ..core.setting_get("remote_port") .."]" ..
		"checkbox[1,4.1;cb_public_serverlist;".. fgettext("Public Serverlist") .. ";" ..
		dump(core.setting_getbool("public_serverlist")) .. "]"

	if not core.setting_getbool("public_serverlist") then
		retval = retval ..
		"button[6.5,4.1;2.25,0.5;btn_delete_favorite;".. fgettext("Delete") .. "]"
	end

	retval = retval ..
		"button[9.3,5.25;2.5,0.5;btn_mp_connect;".. fgettext("Connect") .. "]" ..
		"field[9.3,3.5;2.5,0.5;te_name;;" ..core.setting_get("name") .."]" ..
		"pwdfield[9.3,4.4;2.5,0.5;te_pwd;]" ..
	...
	--favourites
	retval = retval ..
		"textlist[1,0.55;7.7,3.35;favourites;"
